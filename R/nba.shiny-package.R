...
#' @importFrom shinyWidgets show_toast switchInput updateSwitchInput
#' @importFrom tidyselect any_of contains ends_with matches
#' @importFrom stringr str_c str_detect str_extract str_like str_subset str_which
#' @importFrom purrr compact discard discard_at list_rbind map map_chr map_int pluck
